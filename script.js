  ...
  btn.addEventListener("click", () => {
    ...
    if (btn.value == "=") {
      if (
        ...
        // input_box.value = input_box.value.substring(0, input_box.value.length - 1) + input_box.value.substring(input_box.value.length);

        // console.log(input_box.value.charAt(input_box.value.length - 1));
        input_box.value= input_box.value.replace(input_box.value.charAt(input_box.value.length - 1),
        input_box.value.charAt(input_box.value.length - 1) +input_box.value.slice(0, -1)
        );
        console.log( "inside plussshjgbrh" +input_box.value.length - 1 +input_box.value.slice(0, -1));
